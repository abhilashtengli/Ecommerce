...
public class ProductController {
    ...
    public ResponseEntity<ProductDto> updateProduct(@Valid @PathVariable int id, @RequestBody ProductDto productDto)
        ...
        Product prod = productMapper.updateProduct(productDto);
        Product prod1 = productService.updateProductDetails(id, prod);
        ProductDto updatedProduct = productMapper.savedProductDto(prod1);
